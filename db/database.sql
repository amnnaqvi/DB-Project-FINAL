...
(
    ...
    is_sold BIT DEFAULT 1,
    --If the item is sold by the vendor anymore or not
    description TEXT,
...
VALUES
    ('Admin1', 'admin1@habib.edu.pk', 'adminpass1', 1),
...
-- Insert Vendors
INSERT INTO Vendors
    (vendor_name, password, is_active, contact_number, email, admin_id)
VALUES
    ('Cafeela', 'cafee123', 1, '123-456-7890', 'cafeela@habib.edu.pk', 1),
...
-- Insert Users
INSERT INTO Users
    (full_name, type_id, current_balance, email, password, is_active)
VALUES
    ('Amn Naqvi', 1, 630.00, 'sn11@st.habib.edu.pk', 'password123', 1),
...
VALUES
    ('Chicken Sandwich', 100, 200.00, 1, 100, 'Grilled chicken sandwich', 'url1.jpg'),
...
-- Insert Orders
INSERT INTO Orders
    (user_id, vendor_id, is_pickup, total_cost, order_placed, order_received, status)
VALUES
    (1000, 100, 1, 300.00, '2023-04-05 10:00:00', '2023-04-05 10:20:00', 'Ready'),
...
INSERT INTO User_Balance_History
    (user_id, amount, is_deposit, record_date, physical_payment, order_id, admin_id)
VALUES
    (1000, 250.00, 0, '2023-05-01 10:30:00', 0, 2, 1),
...
VALUES
    (1000, 3, '2023-04-01 09:30:00'),
    (1002, 1, '2023-01-25 14:00:00');

USE DBProject;

-- Insert Notification Types
INSERT INTO Notif_Type
    (type)
VALUES
    ('Order Ready'),
    ('Order Delay'),
...
INSERT INTO Notifications
    (notif_type, notif_content, user_id, order_id, sent_at, priority)
VALUES
    (1, 'Order Ready! Please Collect it from Tapal', 1000, 1, '2023-04-05 10:15:00', 1),
...
INSERT INTO Feedback
    (user_id, order_id, rating, rated_at)
VALUES
    (1000, 1, 5, '2023-04-06 10:00:00'),
